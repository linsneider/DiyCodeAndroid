...
public class NewsListPresenter extends BasePresenter<NewsListContract.Model, NewsListContract.View> {
    ...
    @Inject
    public NewsListPresenter(NewsListContract.Model model, NewsListContract.View rootView, RxErrorHandler handler, AppManager appManager, Application application) {
    ...
    public void getNews(int nodeId, boolean isRefresh) {
...
//            isEvictCache = false;
//        }
        mModel.getNews(nodeId, offset, isEvictCache)
