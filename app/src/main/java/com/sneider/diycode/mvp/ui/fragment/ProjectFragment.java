...
import com.sneider.diycode.di.component.DaggerProjectFragmentComponent;
...
import com.sneider.diycode.mvp.presenter.ProjectFragmentPresenter;
...
public class ProjectFragment extends BaseFragment<ProjectFragmentPresenter> implements ProjectFragmentContract.View,  SwipeRefreshLayout.OnRefreshListener {
    ...
    public void setupFragmentComponent(AppComponent appComponent) {
        ...
        DaggerProjectFragmentComponent.builder().appComponent(appComponent)
                .projectFragmentModule(new ProjectFragmentModule(this)).build().inject(this);
    }
    ...
    private void initRecyclerView() {
        ...
        mRecyclerView.setLoadMoreListener(() -> mPresenter.getProjects(false));
        mRecyclerView.setOnClickReloadListener(() -> {
            mRecyclerView.setCanloadMore(true);
            mRecyclerView.showLoadMore();
            mPresenter.getProjects(false);
        });
    }
